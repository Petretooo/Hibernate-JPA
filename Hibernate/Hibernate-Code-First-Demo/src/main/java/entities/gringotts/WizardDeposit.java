...
public class WizardDeposit extends BaseEntity {
    ...
    public int getMagicWancSize() {
        return magicWancSize;
    }

    public void setMagicWancSize(int magicWancSize) {
        this.magicWancSize = magicWancSize;
    }
